    ...
    for markov in markov_length:
        for i in range(len(temps)):
            ...
            for i in range(1, max_i):
                ...
                # costs2.append(cost)
            # print(f"average {iteration} iter, {markov}, t={temp}, cost:", np.mean(costs2))
            # all_costs.append(np.mean(costs2))

    # print("all costs")
    # print(all_costs)
    data = {"Cooling_schedule":schedules, "Cost":costs, "Percentage": percentage_v, "Routes":routes, "Init routes": init_routes}
